...
static const char *HASH_NAME      = "md5(sha1($pass).md5($pass).sha1($pass))";
static const u64   KERN_TYPE      = 20900;
...
static const char *ST_HASH        = "100b3a4fc1dc8d60d9bf40688d8b740a";
